...
import { useAssistant } from "@/entities/alertengine";
import type { AssistantMessage } from "@/entities/alertengine";

type Suggestion = { label: string; prompt: string };

// Suggested questions per page, carried over from the original RansomEye
...
const PAGE_QUESTIONS: Record<string, Suggestion[]> = {
  ...
  correlations: [
    ...
    { label: "What is RansomEye?", prompt: "Explain what RansomEye does." },
  ...
  pipeline: [
    { label: "Pipeline Stages", prompt: "Explain the RansomEye pipeline stages." },
  ...
  return (
    <>
      ...
      <button
        ...
        aria-label="Open RansomEye assistant"
        className={clsx(
      ...
      >
        ...
        <span className="text-sm font-medium">Ask RansomEye</span>
      </button>
      ...
      >
        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="min-w-0">
            <Title className="text-sm truncate">RansomEye Assistant</Title>
