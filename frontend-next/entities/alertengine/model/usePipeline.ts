...
/**
 * SWR key for the whole pipeline state. Every RansomEye page reads from this
...
/** How often to re-poll the pipeline, matching the original RansomEye UI. */
...
/**
 * Raw alerts filtered the way the RansomEye feed variants do:
