...
/**
 * Every endpoint the RansomEye FastAPI backend actually serves
...
/** KeepHQ's own surface, which RansomEye's backend does not implement. */
...
describe("keep mock routing", () => {
  describe("does not shadow the RansomEye backend", () => {
    it.each(RANSOMEYE_ENDPOINTS)(
