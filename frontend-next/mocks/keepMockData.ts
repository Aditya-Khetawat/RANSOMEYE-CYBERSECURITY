 ...
 * still have no real RansomEye equivalent (Keep's own dedup-rules catalogue,
 ...
 * a missing endpoint. Nothing here is wired to the RansomEye engine — every
...
export const PRESETS = [
  {
    ...
    created_by: "demo@ransomeye.local",
    is_private: false,
    is_noisy: false,
