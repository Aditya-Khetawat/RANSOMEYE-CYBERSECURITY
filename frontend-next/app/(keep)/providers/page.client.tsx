...
import { useProviders, useProviderActions } from "@/entities/alertengine";
import { DataTable, TableHead, Th, Tr, Td } from "@/entities/alertengine/ui/Table";
import type { Provider } from "@/entities/alertengine";
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        ...
        <PageSubtitle>
          Real webhook targets RansomEye can notify. Add one, then use Test to
