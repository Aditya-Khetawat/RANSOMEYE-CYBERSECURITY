...
import { AssistantChat } from "@/entities/alertengine/ui/AssistantChat";
import {
  StormControls,
  StormEngine,
} from "@/entities/alertengine/ui/StormControls";
          ...
          <PHProvider>
            <NextAuthProvider session={session}>
              <TopologyPollingContextProvider>
                ...
                {/* Floating RansomEye assistant, available on every page. */}
                <AssistantChat />
