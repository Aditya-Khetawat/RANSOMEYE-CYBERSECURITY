...
import { usePipelineState } from "@/entities/alertengine";
import type { Alert, Cluster } from "@/entities/alertengine";
import { StatCard } from "@/entities/alertengine/ui/StatCard";
import { ClusterCard } from "@/entities/alertengine/ui/ClusterCard";
import { AlertDetailDrawer } from "@/entities/alertengine/ui/AlertDetailDrawer";
import { DataSourceButtons } from "@/entities/alertengine/ui/DataSourceMenu";
import { StormMenu } from "@/entities/alertengine/ui/StormControls";
import { AlertIcon, ServiceChip } from "@/entities/alertengine/ui/AlertIcon";
import {
  DataTable,
  TableHead,
  Td,
  Th,
  Tr,
} from "@/entities/alertengine/ui/Table";
import { riskColor, timeAgo } from "@/entities/alertengine/lib/format";
...
export function HomeClient() {
  ...
  // Stat definitions preserved from the original RansomEye Home page.
  const stats = useMemo(() => {
